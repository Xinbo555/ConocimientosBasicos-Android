...
* **SharedPreferences:** Uso de almacenamiento clave-valor para la persistencia de datos entre actividades.
...
* **MVP (Model-View-Presenter):** Desacoplamiento de la lógica de presentación de la vista.
...
* **Product Flavors:** Configuración de variantes de compilación para personalizar recursos y textos según la versión de la aplicación.
